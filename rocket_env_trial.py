...
class Rocket(gym.Env):
    ...
    def __init__(self, max_steps, task='hover', rocket_type='falcon',
        ...
        # Replace low and high values with appropriate bounds for your environment
        ...
        if path_to_bg_img is None:
            path_to_bg_img = "/Users/rayanmazari/Desktop/Reinforcement learning/RLI_21 - Assignment/RLI_21_P00/"+task+'.jpg'
    ...
    def create_polygons(self):
        ...
        if self.task == 'hover':
            ...
            polys['target_region'].append({'pts': pts1, 'face_color': None, 'edge_color': color})
            polys['target_region'].append({'pts': pts2, 'face_color': None, 'edge_color': color})
        else:
            color = (242, 242, 242)
            color = (242, 0, 0)
            ...
            polys['target_region'].append({'pts': pts1, 'face_color': None, 'edge_color': color})
            polys['target_region'].append({'pts': pts2, 'face_color': None, 'edge_color': color})
            polys['target_region'].append({'pts': pts3, 'face_color': None, 'edge_color': color})
